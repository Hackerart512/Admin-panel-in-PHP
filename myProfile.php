        ...
        <div id="content">
            ...
            <div class="addActivitiesContainer">
                ...
                <div class="profile-content">
                     ...
                     <!-- Myprofile code -->
                     <div class="row ProfileDescription my-3">
                         <div class="col-lg-12 p-0 Profilecard">
                            <img src="../web-panel/images/profile.jpg" />
                            <h3 class="my-3">Pavan prjapat</h3>

                            <div class="ProfileCardDescription">
                            <?php while($row = mysqli_fetch_assoc($result)) {
                                 echo "<strong>EMAIL : </strong>".$row["name"]."
                                 <br>
