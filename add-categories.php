...
if (isset($_POST['submit-btn'])) {
    ...
    $sql = "INSERT INTO `categories`(`Name`,`Description`, `Image`, `Status`) VALUES ('$Name','$Description', '$dst','0')";
         ...
         <div id="content">
             ...
             <div class="addActivitiesContainer">
                 ...
                 <div class="tab-content">
                     ...
                     <form action="add-categories.php" method="POST" class="form-vertical"  enctype="multipart/form-data">
                         <!-- Email input -->
