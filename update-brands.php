...
if (mysqli_connect_errno()) {
    ...
    //     exit();
    // } else {
    //     $selectQuery = "SELECT * FROM `brands`  WHERE `Id`= '$brandId' ;";
...
if ($result->num_rows === 0) {
    ...
    if (isset($_POST['submit-btn'])) {
        ...
        $sql = "UPDATE brands SET `Name` = '$Name', `Image` = '$dst', `Status` = '$Status' WHERE `Id` = '$brandId'";
        ...
        <div id="content">
            ...
            <div class="addActivitiesContainer">
                ...
                <div class="tab-content">
                    ...
                    <form action="update-brands.php?Id=<?php echo $brandId; ?>" method="POST" class="form-vertical" enctype="multipart/form-data">
                        <!-- Email input -->
                        <h2 class="form-div my-3" style="text-align: center">Update Brands</h2 style="text-align: center ">
                        ...
                        <!-- Submit button -->
                        <button name="submit-btn" type="submit" class="btn btn-primary btn-block mb-3">Update Brands</button>
                    </form>
                </div>
                <!-- Pills content -->
            </div>
